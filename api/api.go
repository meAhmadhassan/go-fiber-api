...
func (r *Repository) GetBooks(c *fiber.Ctx) error {
	...
	if err := r.DB.Find(bookModels).Error; err != nil {
		return c.Status(http.StatusBadRequest).JSON(&fiber.Map{"message": "No books found"})
	}

	return c.Status(http.StatusOK).JSON(&fiber.Map{"message": "Books fetched!", "data": bookModels})
}